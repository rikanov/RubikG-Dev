...
template< cube_size N >
void Snapper<N>::toSolve( Rubik<N> * cube )
{
  m_rubik = cube;
}

template< cube_size N >
void Snapper<N>::newTask( const PosID* startPos, const size_t size, const CubeID orient, AcceptFunction acceptFunction )
{
...
template< cube_size N >
void Snapper<N>::maximumTreeHeight( const DistID depth )
{
  m_deepestLevel = m_snapshotArray + depth;
}

template< cube_size N >
bool Snapper<N>::progressResult()
{
...
template< cube_size N >
bool Snapper<N>::setNextState( const RotID rotID )
{
...
template< cube_size N >
bool Snapper<N>::rotate( const RotID rotID )
{
...
template< cube_size N >
void Snapper<N>::initRoot( const CubeID trans )
{
...
template< cube_size N >
bool Snapper<N>::initSearch( const DistID depth)
{
...
template< cube_size N >
void Snapper<N>::startIDA( const CubeID trans )
{
  initRoot( trans );
  DistID height = 0;
...
template< cube_size N >
void Snapper<N>::iterativelyDeepening()
{
  startIDA();
...
template< cube_size N >
void Snapper<N>::start( const size_t tasks )
{
...
template< cube_size N >
void Snapper<N>::printState() const
{
