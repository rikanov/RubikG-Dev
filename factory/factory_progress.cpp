...
public:
  Progress()
    ...
    , m_workers( new Worker[ MaxNumberOfWorkers ] )
    {
    };
...
template< cube_size N >
Factory<N>::Array<BitMapID> Factory<N>::Progress::InitialState::AllowedRotations = Factory<N>::Array<BitMapID>( CRotations<N>::AllRotIDs );
