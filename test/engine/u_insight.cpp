...
template< size_t N >
static void LogTest( Insight<N> & insight, Trial trial )
{
  insight.print();
  for( const RotID rotID : trial )
  {
    insight.rotate( rotID );
    printf( "%3u,%7u,%3u,%3u,   //  %s\n", rotID, insight.state(), insight.prior(), insight.distance(), CExtRotations<N>::ToString( rotID ).c_str() );
...
bool UnitTests::unit_Insight() const
{
  ...
  Trial baseTrial_2 = {
                ...
                CExtRotations<2>::GetRotID( _Z, 1, 3 ),
                CExtRotations<2>::GetRotID( _Z, 0, 3 ),
                CExtRotations<2>::GetRotID( _X, 1, 1 ),
                CExtRotations<2>::GetRotID( _Y, 0, 3 ),
                CExtRotations<2>::GetRotID( _Z, 1, 1 ),
                CExtRotations<2>::GetRotID( _Z, 0, 3 )
              };
  ...
  Trial transTrial_2 = {
                CExtRotations<2>::GetRotID( _Z, 1, 1 ),
                CExtRotations<2>::GetRotID( _Y, 1, 3 ),
                CExtRotations<2>::GetRotID( _Y, 0, 1 ),
                CExtRotations<2>::GetRotID( _X, 1, 2 ),
                CExtRotations<2>::GetRotID( _Z, 0, 2 ),
                CExtRotations<2>::GetRotID( _Y, 1, 1 ),
                CExtRotations<2>::GetRotID( _Z, 0, 2 ),
                CExtRotations<2>::GetRotID( _Z, 0, 3 ),
                CExtRotations<2>::GetRotID( _X, 1, 2 ),
                CExtRotations<2>::GetRotID( _Y, 0, 3 ),
  ...
  Trial baseTrial_3 = {
                ...
                CExtRotations<3>::GetRotID( _Z, 2, 2 ),
                CExtRotations<3>::GetRotID( _Y, 0, 3 ),
                CExtRotations<3>::GetRotID( _X, 1, 1 ),
                CExtRotations<3>::GetRotID( _Y, 1, 3 ),
                CExtRotations<3>::GetRotID( _X, 1, 2 ),
                CExtRotations<3>::GetRotID( _Z, 2, 3 )
              };
Trial transTrial_3 = {
                CExtRotations<3>::GetRotID( _Y, 2, 2 ),
                CExtRotations<3>::GetRotID( _Y, 2, 1 ),
                CExtRotations<3>::GetRotID( _Y, 2, 1 ),
                CExtRotations<3>::GetRotID( _X, 1, 3 ),
                CExtRotations<3>::GetRotID( _Y, 0, 1 ),
                CExtRotations<3>::GetRotID( _Z, 1, 2 ),
                CExtRotations<3>::GetRotID( _Z, 1, 2 ),
                CExtRotations<3>::GetRotID( _Y, 0, 3 ),
                CExtRotations<3>::GetRotID( _X, 1, 1 ),
                CExtRotations<3>::GetRotID( _X, 2, 3 ),
                CExtRotations<3>::GetRotID( _X, 2, 2 ),
                CExtRotations<3>::GetRotID( _X, 2, 1 )
              };
  ...
  Trial baseTrial_5 = {
                CExtRotations<5>::GetRotID( _X, 5, 1 ),
                CExtRotations<5>::GetRotID( _X, 6, 3 ),
                CExtRotations<5>::GetRotID( _X, 2, 1 ),
                CExtRotations<5>::GetRotID( _Z, 4, 2 ),
                CExtRotations<5>::GetRotID( _Y, 5, 1 ),
                CExtRotations<5>::GetRotID( _Z, 2, 2 ),
                CExtRotations<5>::GetRotID( _Z, 2, 2 ),
                CExtRotations<5>::GetRotID( _Y, 5, 3 ),
                CExtRotations<5>::GetRotID( _Z, 4, 2 ),
                CExtRotations<5>::GetRotID( _Y, 6, 1 ),
                CExtRotations<5>::GetRotID( _Y, 6, 2 ),
                CExtRotations<5>::GetRotID( _Y, 6, 1 )
              };

  Trial transTrial_5 = {
                CExtRotations<5>::GetRotID( _Y, 5, 1 ),
                CExtRotations<5>::GetRotID( _Y, 6, 3 ),
                CExtRotations<5>::GetRotID( _Y, 2, 1 ),
                CExtRotations<5>::GetRotID( _X, 4, 2 ),
                CExtRotations<5>::GetRotID( _Y, 5, 1 ),
                CExtRotations<5>::GetRotID( _X, 6, 2 ),
                CExtRotations<5>::GetRotID( _X, 6, 2 ),
                CExtRotations<5>::GetRotID( _Y, 5, 3 ),
                CExtRotations<5>::GetRotID( _X, 4, 2 ),
                CExtRotations<5>::GetRotID( _Y, 6, 1 ),
